...
import glsib.stage2025.security.CustomUserDetailsService;
import glsib.stage2025.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationFilter jwtFilter) throws Exception {
        ...
        http
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/services/**").hasRole("FOURNISSEUR")
                .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/services/**").hasRole("FOURNISSEUR")
                .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/reservations/**").hasAnyRole("CLIENT", "FOURNISSEUR", "ADMIN")
                .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/reservations/**").hasRole("CLIENT")
